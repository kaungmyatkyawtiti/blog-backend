...
export type CommentLikeWhereInput = {
  ...
  created?: Prisma.DateTimeFilter<"CommentLike"> | Date | string
...
export type CommentLikeScalarWhereWithAggregatesInput = {
  ...
  created?: Prisma.DateTimeWithAggregatesFilter<"CommentLike"> | Date | string
}
...
export type CommentLikeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "commentId" | "userId" | "created", ExtArgs["result"]["commentLike"]>
...
export interface CommentLikeFieldRefs {
  ...
  readonly created: Prisma.FieldRef<"CommentLike", 'DateTime'>
}
